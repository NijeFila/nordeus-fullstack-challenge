...
namespace NordeusChallenge.Client.Visual
{
    ...
    public class VisualCatalog : ScriptableObject
    {
        ...
        [SerializeField] private List<SpriteEntry> itemIcons = new();
        [SerializeField] private List<SpriteEntry> statIcons = new();
        ...
        public Sprite GetItemIcon(string itemId) => Lookup(itemIcons, itemId, defaultItemIcon);
        public Sprite GetStatIcon(string statId) => Lookup(statIcons, statId, defaultStatIcon);
